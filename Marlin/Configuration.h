...
// RAMPS 1.4 has 4k7 pullup and e3d v6 lite uses Semitec 104GT2 100k hence 5...
...
// todo: could be higher e.g. 15!? better?
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // todo: update pid parameters after pid tuning or are there values somewhere?
